package com.sun.bingo.framework.http.HttpCallBack;
 ...
 * 支持穿透解析
 */
public abstract class AbstractParserCallBack<T> extends RequestCallBack<String> {
    ...
    @Override
    public final void onSuccess(ResponseInfo<String> stringResponseInfo) {
        try {
            parserResult(interceptParser(stringResponseInfo.result), mTitle);
